...
<blockquote> <sup>1</sup>unité d’œuvre, poids d’une User Storie ça n’a pas d’importance. L’objectif est bien de rattacher une fonctionnalité à une unité pour rendre le pilotage plus facile.</blockquote>

<blockquote> <sup>2</sup>Oncle Bob estime que c’est la principale raison d’un échec lors de l’utilisation de l’agilité : ne pas produire de manière continue, un logiciel qui fonctionne !</blockquote>

<blockquote> <sup>3</sup> Y = Durée du projet / ( X * Durée Itération)</blockquote>
