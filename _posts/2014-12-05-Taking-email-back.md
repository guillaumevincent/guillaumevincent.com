...
revealing the close collaboration between webmail and the US Secret Service, I started looking for an alternative to 
manage my emails differently. Since March 2014, I finally have an email address that works. In this post I will share 
with you my experience and help you to take your emails back!

<!--more-->
<p class="bg-success">
In this tutorial we will learn to configure OpenSMTPD and Dovecot.
To accomplish this tutorial, you will need:
</p>
<ul>
<li>a personal server (VPS, dedicated machine) with a recent operating system (Ubuntu 14.04 or FreeBSD 9.3)</li>
<li>a domain name</li>
...
<li>master the basics of system administration (install packages, edit configuration files, etc.)</li>
</ul>
